...
class Conversation extends Component {
  ...
  // componentDidUpdate() {
  //   window.scroll(0, (document.getElementsByClassName('site-content')[0].offsetHeight));
  // }
  componentDidUpdate() {
    const c = document.getElementsByClassName('loader');
    if (c.length >= 1) {
  ...
  render() {
    ...
    const listenerID = 'UNIQUE_LISTENER_ID_2';
          ...
          : convoWith && convoWith.uid ?
            <div className="convo-container">
              <PageHeader
                ...
                onBack={() => this.props.history.push('/messages')}
                title={
                        ...
                        Object.keys(convo).map(co => (
                          <div className="grp-msgs" key={co}>
                            ...
                            </Text>
                            {
                              (convo[co]).map(c => (
                              c.sender === _id ?
                                <div key={c.id} id="slc" className="msg-me">
                                  <div>
